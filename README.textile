...
This plugin now requests Java 7.  Using concurrent Maps, Sets and Lists that are only in Java 7.
...
**Project tracker:** "http://doc4web.com/icescrum/p/ELASTIC#project":http://doc4web.com/icescrum/p/ELASTIC#project
